	...
	<!--<div class="5grid-layout">
		<div class="row">
			<div id="banner" class="12u">
				<div class="container"><a href="#"><img src="images/home_image.jpg" alt=""></a></div>
			</div>
		</div>
	</div>-->
	<div id="marketing">
				...
				<div class="3u">
					<section>
						<div class="mbox-style">
							<h2 class="title">FOR SCHOOLS/COLLEGES/EDUCATIONAL INSTITUTE</h2>
							<div class="content">
								<p class="subtitle">They play an important role in enhancing educational
                                                                    competence as well promoting Psycho social development of its STUDENTS,
                                                                    we offer program for students,from 13 to 25 years of age  with the aim
                                                                    of empowering them to make right choices, being more responsible setting
                                                                    goals and owning up actions </p>
							</div>
				...
				<div class="3u">
					<section>
						<div class="mbox-style">
							...
							<div class="content">
                                                            <p class="subtitle"><b>Parents as coach</b>
                                                                    is the program which includes workshop that
                                                                    helps parents in identifying their parenting style
                                                                    and guides them. Worshop on Career awareness for parents
                                                                    which develops an understanding in parents regarding their
                                                                    role as a coach/guide for children </p>
							</div>
							<!--<p class="button-style2"><a href="#">More Details</a></p>-->
						</div>
					</section>
				...
				<div class="3u">
					<section>
						<div class="mbox-style">
							...
							<div class="content">
								<p class="subtitle"><b>Teachers as reflective practioners</b>
                                                                    is the program which includes 
                                                                    Progressive workshop for teachers 
                                                                    for their professional and personal upgradation</p>
							</div>
							<!--<p class="button-style2"><a href="#">More Details</a></p>-->
						</div>
					</section>
			...
			<div class="row">
				...
				<!--<div class="6u">
					<div class="mobileUI-main-content" id="content">
						<section>
							<div class="post">
								<p>Udaan4you offers developmental programs for students, Teachers and parents.  Primarily  has been created with the objective of serving the career counseling needs of the students . </p>
                                                                <p><a href="#"><img style="height: 200px" src="images/pics03.jpg" alt=""></a><br>
                                                            <p>	
